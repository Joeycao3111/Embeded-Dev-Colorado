###******************************************************************************
# Copyright (C) 2020 by Joey Cao - Student
#
...
### The repository is organized in multiple files:
###      stat.c -> Analyze and reorder dataset, and finaly print to the screen 
###      stat.h -> Function declaration
